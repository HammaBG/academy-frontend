...
export function Navbar() {
  ...
  useEffect(() => {
    const handleClickOutside = (e: MouseEvent) => {
      ...
      if (searchRef.current && !searchRef.current.contains(target) && !(target as HTMLElement).closest(".search-overlay")) {
  ...
  return (
    <>
      ...
      {isSearchOpen && (
        <div className="fixed inset-0 bg-background/95 backdrop-blur-lg z-[999] overflow-y-auto search-overlay" dir="rtl">
